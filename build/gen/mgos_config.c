 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/data/fwbuild-volumes/2.17.0/apps/HelloWorld/esp32/build_contexts/build_ctx_977967492/build/gen/ /mongoose-os/src/mgos_debug_udp_config.yaml /mongoose-os/platforms/esp32/src/esp32_sys_config.yaml /data/fwbuild-volumes/2.17.0/apps/HelloWorld/esp32/build_contexts/build_ctx_977967492/build/gen/mos_conf_schema.yml
 */
...
const struct mgos_conf_entry mgos_config_schema_[382] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .offset = 0, .num_desc = 381},
...
const struct mgos_conf_entry *mgos_config_schema_azure(void) {
  return mgos_conf_find_schema_entry("azure", mgos_config_schema());
}
bool mgos_config_parse_azure(struct mg_str json, struct mgos_config_azure *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_azure(const struct mgos_config_azure *src, struct mgos_config_azure *dst) {
  return mgos_conf_copy(mgos_config_schema_azure(), src, dst);
}
void mgos_config_free_azure(struct mgos_config_azure *cfg) {
  return mgos_conf_free(mgos_config_schema_azure(), cfg);
}
...
const struct mgos_conf_entry *mgos_config_schema_rpc_azure(void) {
  return mgos_conf_find_schema_entry("rpc.azure", mgos_config_schema());
}
bool mgos_config_parse_rpc_azure(struct mg_str json, struct mgos_config_rpc_azure *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_rpc_azure(const struct mgos_config_rpc_azure *src, struct mgos_config_rpc_azure *dst) {
  return mgos_conf_copy(mgos_config_schema_rpc_azure(), src, dst);
}
void mgos_config_free_rpc_azure(struct mgos_config_rpc_azure *cfg) {
  return mgos_conf_free(mgos_config_schema_rpc_azure(), cfg);
}
...
const struct mgos_conf_entry *mgos_config_schema_rpc_gatts(void) {
  return mgos_conf_find_schema_entry("rpc.gatts", mgos_config_schema());
}
bool mgos_config_parse_rpc_gatts(struct mg_str json, struct mgos_config_rpc_gatts *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_rpc_gatts(const struct mgos_config_rpc_gatts *src, struct mgos_config_rpc_gatts *dst) {
  return mgos_conf_copy(mgos_config_schema_rpc_gatts(), src, dst);
}
void mgos_config_free_rpc_gatts(struct mgos_config_rpc_gatts *cfg) {
  return mgos_conf_free(mgos_config_schema_rpc_gatts(), cfg);
}
...
const struct mgos_conf_entry *mgos_config_schema_rpc_gcp(void) {
  return mgos_conf_find_schema_entry("rpc.gcp", mgos_config_schema());
}
bool mgos_config_parse_rpc_gcp(struct mg_str json, struct mgos_config_rpc_gcp *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_rpc_gcp(const struct mgos_config_rpc_gcp *src, struct mgos_config_rpc_gcp *dst) {
  return mgos_conf_copy(mgos_config_schema_rpc_gcp(), src, dst);
}
void mgos_config_free_rpc_gcp(struct mgos_config_rpc_gcp *cfg) {
  return mgos_conf_free(mgos_config_schema_rpc_gcp(), cfg);
}
...
const struct mgos_conf_entry *mgos_config_schema_watson(void) {
  return mgos_conf_find_schema_entry("watson", mgos_config_schema());
}
bool mgos_config_parse_watson(struct mg_str json, struct mgos_config_watson *cfg) {
  return mgos_conf_parse_sub(json, mgos_config_schema(), cfg);
}
bool mgos_config_copy_watson(const struct mgos_config_watson *src, struct mgos_config_watson *dst) {
  return mgos_conf_copy(mgos_config_schema_watson(), src, dst);
}
void mgos_config_free_watson(struct mgos_config_watson *cfg) {
  return mgos_conf_free(mgos_config_schema_watson(), cfg);
}
